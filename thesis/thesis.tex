...
\subsection{Krótki okres czasu}
Otrzymane odpowiedzi w czasie 1 sekundy - .

\subsection{Średni okres czasu}
Otrzymane odpowiedzi w czasie 30 sekund - .

\subsection{Duży okres czasu}
Otrzymane odpowiedzi w czasie 10 minut - .

\subsection{Podsumowanie testu}
Przedstawione wyniki prezentują możliwości obsługi kolejnych zapytań serwera node.js. 
Osiągnięte wyniki są zadowalające, jednak łatwo zauważyć że technologia ta wykazuje się największą sprawnością przy obsłudzę równoległych zapytań. 
Średni uzyskany czas dla obsługi 1500 zapytań równoległych to ms, natomiast dla wysyłanych kolejno wynosi ms.
