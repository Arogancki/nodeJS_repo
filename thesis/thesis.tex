...
\begin{center}
  \begin{tabular}{ | c | c | c | c | c | c | }
    \hline
    & logowanie & otrzymanie informacji o tablicach i zaproszeniach & dodanie nowej tablicy & dodanie nowego zadania & dodanie komentarza \\ \hline
	Mała ilość danych \newline 5 użytkowników po 2 tablice po 3 zadania po 2 komentarze & 22ms & 29ms & 20ms & 27ms & 26ms \\ \hline
	Średnia ilość danych \\  50 użytkowników po 4 tablice po 6 zadań po 5 komentarzy: & 26ms & 33ms & 27ms & 35ms & 30ms \\ \hline
	Duża ilość danych \\  500 użytkowników po 8 tablic po 12 zadań po 11 komentarzy & 32ms & 39ms & 31ms & 37ms & 32ms 
    \hline
  \end{tabular}
\end{center}
