      ...
      \begingroup
        ...
        \begin{adjustbox}{center}
          \begin{tabular}{|c|c|c|c|c|c|p{2.5cm}}
            ...
            \hline
            \parbox{2.5cm}{Średnia ilość dla 1 sekundy} & 210 & 113 & 146 & 299 & 64 \\
            \hline
          \end{tabular}
        \end{adjustbox}
      \endgroup
      ...
      \begingroup
        ...
        \begin{adjustbox}{center}
          \begin{tabular}{|c|c|c|c|c|c|p{2.6cm}}
            ...
            \hline
            \parbox{2.6cm}{5 jednocześnie wysłanych zapytań} & 1.174 & 0.02 & 0.015 & 0.002 & 0.003 \\
            \hline
            \parbox{2.6cm}{30 jednocześnie wysłanych zapytań} & 1.552 & 0.107 & 0.063 & 0.013 & 0.014 \\
            \hline
            \parbox{2.6cm}{150 jednocześnie wysłanych zapytań} & 7.799 & 0.407 & 0.282 & 0.066 & 0.069 \\
            \hline
            \parbox{2.6cm}{Średni czas dla 1 zapytania} & 0.056 & 0.02 & 0.02 & 0.0004 & 0.0004 \\
            \hline
          \end{tabular}
        \end{adjustbox}
      \endgroup
      ...
      \begingroup
        ...
        \begin{adjustbox}{center}
          \begin{tabular}{|c|c|c|c|c|c|p{2.5cm}}
            ...
            \hline
            \parbox{2.5cm}{Średnia ilość dla 1 sekundy} & 103 & 85 & 95 & 137 & 56 \\
            \hline
          \end{tabular}
        \end{adjustbox}
      \endgroup
