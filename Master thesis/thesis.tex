...
\chapter{Analiza porównawcza}
  ...
  \section{Meteor}
    \subsection{Rozmiar frameworku}
      ...
      Do folderu projektu zostaje również dołączone środowisko uruchomieniowe oraz wspomagające biblioteki i całość waży 454 MB.
      Można więc uznać to za wagę wyjściową, która powinna być wzięta przy analizie.
    ...
    \subsection{Próg wejścia}
      ...
      Ponieważ meteor jest znacząco inny od pozostałych framework'ów nie potrzebujemy mięć dużej wiedzy o technologii nodejs - wystarczy nam javaScript.
      ...
      \smallskip
        \begin{center}
          \begin{tabular}{ | c | c | c | c | c | c | }
            ...
            \hline
            Średni czas dla 1 zapytania & 0.028 & 0.023 & 0.014 & 0.006 & 0.036 \\
            \hline
          \end{tabular}
        \end{center}
      \bigskip\medskip
    ...
    \subsection{Ilość kodu do napisania}
      Ilość wytworzonych lini kodu to 255.
      ...
      Najbardziej przydatnimi featurami oferowanymi przez biblioteke są:
      \newline
      Publish/subscribe - pozwalające na reaktywne programowanie zdarzeń oraz reakcji na ich zajście.
      \newline
      Blaze oraz Tracker - silnik pozwalający na zarządzanie reaktywne danymi zarówno po stronie widoku oraz bazy danych bez potrzeby tworzenia reaktywnej logiki.
      \newline
      Automatyczna obsługa oraz synchronizacjia bazy danych nawet w przypadku wielu użytkowników bez potrzeby tworzenia dodatkowej logiki.
      \newline
      Użycie globalnej zmiennej Meteor w każdym miejscu w kodzie, która posiad dostęp do wszystkich części aplikacji.
      \newline
      Wbudowana obsługa wielu strategi autoryzacji użytkownika.
      \newline
      Framework wymaga wytworzenia wyjątkowo niewielkiej ilo
