...
\item Czas uruchomienia jest niedłuży niż 10 sekund.
...
\captionsetup{labelformat=empty}
\caption[]{Serwer sprawdza poprawność otrzymanych danych i w odpowiedzi przesyła stronę główną aplikacji dostępną po zalogowaniu na konto lub informacje o błędzie.}
\end{figure}
...
\captionsetup{labelformat=empty}
\caption[]{Po kliknięciu w link. Serwer sprawdza czy otrzymany w linku kod jest prawidłowy dla podanego użytkownika. 
