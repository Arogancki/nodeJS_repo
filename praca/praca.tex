...
\subsection{Mała ilość danych}
Czas otrzymania odpowiedzi na 50 jednocześnie wysłanych zapytań - .

\subsection{Średnia ilość danych}
Czas otrzymania odpowiedzi na 300 jednocześnie wysłanych zapytań - .

\subsection{Duża ilość danych}
Czas otrzymania odpowiedzi na 1500 jednocześnie wysłanych zapytań - .
