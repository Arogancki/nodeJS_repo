...
Czas otrzymania odpowiedzi dla poszczególnych funkcjonalności od aplikacji z bazą danych z 5 użytkownikami, każdy po 2 tablice po 3 zadania po 2 komentarze: \newline
logowanie - xx\newline
...
Czas otrzymania odpowiedzi dla poszczególnych funkcjonalności od aplikacji z bazą danych z 100 użytkownikami, każdy po 10 tablic po 3 zadania po 2 komentarze: \newline
logowanie - xx\newline
otrzymanie informacji o tablicach i zaproszeniach - xx\newline
dodanie nowej tablicy - xx\newline
dodanie nowego zadania - xx\newline
...
Czas otrzymania odpowiedzi dla poszczególnych funkcjonalności od aplikacji z bazą danych z 5000 użytkownikami, każdy po 50 tablic po 50 zadań po 10 komentarzy: \newline
logowanie - xx\newline
otrzymanie informacji o tablicach i zaproszeniach - xx\newline
dodanie nowej tablicy - xx\newline
dodanie nowego zadania - xx\newline
...
Serwis oferuje pełną funkcjonalność przy różnych obciążeniach bazy danych. Mimo dużej ilości danych korzystanie z serwisu jest komfortowe.
...
\subsection{Mała ilość danych}
Czas otrzymania odpowiedzi na 100 jednocześnie wysłanych zapytań - .

\subsection{Średnia ilość danych}
Czas otrzymania odpowiedzi na 1000 jednocześnie wysłanych zapytań - .

\subsection{Duża ilość danych}
Czas otrzymania odpowiedzi na 10000 jednocześnie wysłanych zapytań - .

\subsection{Podsumowanie testów}
Serwis oferuje pełną funkcjonalność przy różnym stopniu obciążenia serwera. Przy dużej liczbie przychodzących zapytań użytkowanie serwisu jest komfortowe. Aplikacja wykazuje się skalowalnością.
