...
Otrzymane odpowiedzi w czasie 1 sekundy - ms.

\subsection{Średni okres czasu}
Otrzymane odpowiedzi w czasie 30 sekund - ms.

\subsection{Duży okres czasu}
Otrzymane odpowiedzi w czasie 10 minut - ms.

\subsection{Podsumowanie testów}
Przedstawione wyniki prezentują możliwości obsługi kolejnych zapytań serwera node.js. Osiągnięte wyniki są zadowalające, jednak łatwo zauważyć że technologia ta wykazuje się największą sprawnością przy obsłudzę równoległych zapytań. Uzyskany czas dla obsługi 1000  zapytań równoległych to około xxx, natomiast dla wysyłanych kolejno wynosi yyy.
