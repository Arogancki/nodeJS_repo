...
\subsection{Mała ilość danych}
Czas otrzymania odpowiedzi na 50 jednocześnie wysłanych zapytań - ms.

\subsection{Średnia ilość danych}
Czas otrzymania odpowiedzi na 300 jednocześnie wysłanych zapytań - ms.

\subsection{Duża ilość danych}
Czas otrzymania odpowiedzi na 1500 jednocześnie wysłanych zapytań - ms.
